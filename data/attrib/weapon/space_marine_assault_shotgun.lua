...
GameData["area_effect"]["weapon_damage"]["modifiers"]["modifier_01"]["max_lifetime"] = 2.5
...
GameData["requirements"]["required_1"]["global_addon_name"] = "space_marine_hq_scout_focus_cqc"
...
GameData["ui_info"]["help_text_list"]["text_01"] = "- Combat shotgun loaded with explosive man-killer rounds."
GameData["ui_info"]["help_text_list"]["text_02"] = "- Largely maintains accuracy while firing on the move."
GameData["ui_info"]["help_text_list"]["text_03"] = "- Slows movement speed of targeted enemies."
GameData["ui_info"]["help_text_list"]["text_04"] = "- High damage but low armor penetration."
GameData["ui_info"]["help_text_list"]["text_05"] = "$98032"
GameData["ui_info"]["help_text_list"]["text_06"] = "$98043"
