...
GameData["ui_info"]["help_text_list"]["text_01"] = "$4350073"
GameData["ui_info"]["icon_name"] = "sisters_icons/research_max_weapons"
GameData["ui_info"]["screen_name_id"] = "$4350072"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 590600, rangeEnd = 590649, }
