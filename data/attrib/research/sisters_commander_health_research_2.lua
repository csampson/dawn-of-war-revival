...
GameData["ui_info"]["help_text_list"]["text_03"] = "$4350038"
GameData["ui_info"]["icon_name"] = "sisters_icons/research_commander_health_2"
GameData["ui_info"]["screen_name_id"] = "$4350037"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 590300, rangeEnd = 590349, }
