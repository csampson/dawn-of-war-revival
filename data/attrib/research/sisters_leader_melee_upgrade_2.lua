...
GameData["requirements"]["required_10"]["research_name"] = "research\\sisters_leader_melee_upgrade_1.lua"
GameData["requirements"]["required_11"] = Reference([[requirements\required_research.lua]])
GameData["requirements"]["required_11"]["research_name"] = "research\\sisters_leader_melee_upgrade_1.lua"
GameData["ui_hotkey_name"] = "sisters_research_leader_melee_2"
GameData["ui_info"]["help_text_list"]["text_01"] = "$4350064"
GameData["ui_info"]["help_text_list"]["text_02"] = "$4350065"
GameData["ui_info"]["help_text_list"]["text_03"] = "$4350066"
GameData["ui_info"]["icon_name"] = "sisters_icons/research_leader_melee_2"
GameData["ui_info"]["screen_name_id"] = "$4350063"


MetaData["$METADATATAG"] = {desc = [[]], type = 7, category = [[]], dispval = [[]], isLocked = false, rangeStart = 594300, rangeEnd = 594349, }
