...
GameData["squad_ui_ext"]["ui_info"]["help_text_list"]["text_02"] = "- Long-fire fire support specialists, capable of dishing out firepower that can threaten most target types."
