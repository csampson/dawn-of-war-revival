GameData = Inherit([[ebps\races\guard\troops\guard_heavy_weapons_team_entrenched_sp.lua]])
MetaData = InheritMeta([[ebps\races\guard\troops\guard_heavy_weapons_team_entrenched_sp.lua]])
